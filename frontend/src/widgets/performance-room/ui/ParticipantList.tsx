...
/** 왕관·접속 점 등 행 앞 표시를 같은 폭에 맞춰 아바타 열을 정렬한다. */
function ParticipantLeadingSlot({ children }: { children: React.ReactNode }) {
  return <span className="grid size-3.5 shrink-0 place-items-center">{children}</span>;
}
